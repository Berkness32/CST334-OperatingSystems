...
typedef struct Group {
    ...
    char group_name[50]; // todo: Pick an appropriate type for this!
    Person* group_members[GROUP_MAX_SIZE]; // todo: Pick an appropriate type for this!
    int num_members; // todo: Pick an appropriate type for this!
} Group;
